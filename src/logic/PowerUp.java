...
public class PowerUp {
	...
	public Image getPowerUpImage(String currentPowerUp) {
		...
		ImageIcon powerUpIcon = null;

		if (currentPowerUp.equalsIgnoreCase("Points")) {
			powerUpIcon = new ImageIcon(Main.loader.load(
					"images\\powers:pointsPower.png").getAbsolutePath());
		} else if (currentPowerUp.equalsIgnoreCase("Speed")) {
			powerUpIcon = new ImageIcon(Main.loader.load(
					"images\\powers:speedPower.png").getAbsolutePath());
		} else if (currentPowerUp.equalsIgnoreCase("Time Slow")) {
			powerUpIcon = new ImageIcon(Main.loader
					.load("images\\powers:slowPower.png").getAbsolutePath());
		} else if (currentPowerUp.equalsIgnoreCase("Bullet Rain")) {
			powerUpIcon = new ImageIcon(Main.loader.load(
					"images\\powers:bulletRainPower.png").getAbsolutePath());
		} else if (currentPowerUp.equalsIgnoreCase("Invincibility")) {
			powerUpIcon = new ImageIcon(Main.loader.load(
					"images\\powers:shieldPower.png").getAbsolutePath());
		}
